...
"""autogenerated by genpy from navigation/NavigationActionResult.msg. Do not edit."""
import codecs
import sys
...
class NavigationActionResult(genpy.Message):
  _md5sum = "fe6735dbc94f848b2776af8b50e1a6de"
  _type = "navigation/NavigationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','navigation/NavigationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NavigationActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = navigation.msg.NavigationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = navigation.msg.NavigationResult()
