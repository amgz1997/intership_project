...
"""autogenerated by genpy from navigation/LocalisationActionResult.msg. Do not edit."""
import codecs
import sys
...
class LocalisationActionResult(genpy.Message):
  _md5sum = "fe6735dbc94f848b2776af8b50e1a6de"
  _type = "navigation/LocalisationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','navigation/LocalisationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LocalisationActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = navigation.msg.LocalisationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = navigation.msg.LocalisationResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.result_code,) = _get_struct_I().unpack(str[start:end])
      return self
