...
"""autogenerated by genpy from navigation/PickUpPoseActionResult.msg. Do not edit."""
import codecs
import sys
...
class PickUpPoseActionResult(genpy.Message):
  ...
  _type = "navigation/PickUpPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','navigation/PickUpPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = navigation.msg.PickUpPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = navigation.msg.PickUpPoseResult()
