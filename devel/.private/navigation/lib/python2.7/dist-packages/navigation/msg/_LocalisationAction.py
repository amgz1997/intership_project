...
"""autogenerated by genpy from navigation/LocalisationAction.msg. Do not edit."""
import codecs
import sys
...
class LocalisationAction(genpy.Message):
  _md5sum = "9b9b326730367b06dc7edb7343f0b053"
  _type = "navigation/LocalisationAction"
...
"""
  ...
  _slot_types = ['navigation/LocalisationActionGoal','navigation/LocalisationActionResult','navigation/LocalisationActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LocalisationAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = navigation.msg.LocalisationActionGoal()
      if self.action_result is None:
        self.action_result = navigation.msg.LocalisationActionResult()
      if self.action_feedback is None:
        self.action_feedback = navigation.msg.LocalisationActionFeedback()
    else:
      self.action_goal = navigation.msg.LocalisationActionGoal()
      self.action_result = navigation.msg.LocalisationActionResult()
      self.action_feedback = navigation.msg.LocalisationActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_4I().pack(_x.action_goal.goal.target, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_4I().pack(_x.action_result.result.result_code, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.target, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.result_code, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
