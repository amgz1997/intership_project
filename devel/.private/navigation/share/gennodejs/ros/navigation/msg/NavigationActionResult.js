...
class NavigationActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new NavigationResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = NavigationResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavigationActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = NavigationResult.Resolve(msg.result)
    }
    else {
      resolved.result = new NavigationResult()
    }
...
module.exports = NavigationActionResult;
