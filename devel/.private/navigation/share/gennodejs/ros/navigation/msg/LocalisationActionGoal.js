...
class LocalisationActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new LocalisationGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LocalisationGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LocalisationActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = LocalisationGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new LocalisationGoal()
    }
...
module.exports = LocalisationActionGoal;
